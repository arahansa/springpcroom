package com.arahansa.pcroom.asset;
...
public class Setting {
	...
	private static int basicWidth = 1600, basicHeight = 900;
	...
	public static Point bPoint = new Point(basicWidth, basicHeight); // 1600, 900
	public static Dimension bDimen = new Dimension(basicWidth, basicHeight);
	...
	// Screen x,y
	public static int locationX = (windowSize.width - basicWidth) / 2;
	public static int locationY = (windowSize.height - basicHeight) / 2;
